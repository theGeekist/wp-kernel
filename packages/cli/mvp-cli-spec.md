...
- `wpk/doc-links`: attach documentation URLs to diagnostics.

Lint rules run on save and before the generate pipeline, preventing invalid configs from reaching printers.
