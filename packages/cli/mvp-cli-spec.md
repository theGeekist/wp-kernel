...
end safeguards: - Check git cleanliness unless `--yes`. - Optionally copy block artefacts (PHP manifest, JS bundles) into user directories. - Retain `.wpk-apply.log` audit trail.
