...
- CLI tasks on the MVP board ship against the shared **v0.10.x** pre-1.0 line; plan your change sets so they trigger either a patch or minor bump for every package when merged.
