...
| Slot                                                                                                | Task                                                | Status     | Notes                                                                                                                                                                                                     | Reference                                                                                           |
| --------------------------------------------------------------------------------------------------- | --------------------------------------------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| 0.10.1                                                                                              | Task 37 – Register the bootstrap workspace          | ✓ shipped  | Workspace scaffolded via `scripts/register-workspace.ts`; `@wpkernel/create-wpk` now ships the npm/pnpm/yarn bootstrap binary with argument forwarding, telemetry, and smoke coverage landing in Task 38. | [Spec](./phase-7-plugin-bootstrap.md#patch-0101---task-37-register-the-bootstrap-workspace)         |
...
| 0.10.3                                                                                              | Task 39 – Init adoption guardrails                  | ⬜ Planned | Teach `wpk init` to detect existing plugin assets, seed only missing kernel files, and document the preservation path.                                                                                    |
