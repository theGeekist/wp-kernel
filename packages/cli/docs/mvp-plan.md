...
| 0.10.3                                                                                              | Task 39 – Init adoption guardrails                  | ⬜ Planned | Teach `wpk init` to detect existing plugin assets, seed only missing Wpkernel files, and document the preservation path.                                                                                             |
...
### Phase 8 – UI baseline experience (⬜ Planned)
