...
| 0.7.5 | Task 24 - Policy helper parity                      | ⬜ planned | Port the legacy policy helper enforcement (cap checks, binding resolution, structured errors) into the AST pipeline and restore reporter parity.         | [Policy helper parity](./php-ast-migration-tasks.md#task-24---policy-helper-parity)                                 |
