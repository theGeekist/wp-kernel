...
### Phase 2 - Transient Storage Parity (🚧 Active)
...
| 0.5.3 | Task 13 - Transient fixtures & docs        | 🚧 in-progress | Regenerating CLI goldens + docs so transient helpers surface in fixtures and contributor guides.               | [Phase 2 - transient fixtures/docs](./php-ast-migration-tasks.md#task-13--transient-fixtures-and-docs) |
