...
| 0.5.4 | Task 14 - Buffer slot for transient parity | 🚧 in-progress | Buffer slot engaged to ship transient DELETE handling regression fix uncovered after Task 13 landed.           | [Phase 2 - buffer cadence](./php-ast-migration-tasks.md#task-14--phase-2-buffer-slot)                  |
