...
- Shift taxonomy read tests to the helper pipeline, snapshotting the queued AST programs to confirm pagination math and response shaping remain intact.【F:packages/cli/src/next/builders/php/printers/**tests**/resourceController.test.ts†L1-L220】
- **Parallel track:** captured reusable AST helper responsibilities and extension points in this phase summary so subsequent storage modes can mirror the pagination maths, request filtering, and term shaping patterns without revisiting string printers.【F:packages/cli/src/next/builders/php/printers/resource/wpTaxonomy/helpers.ts†L1-L260】【F:packages/cli/docs/next-php-ast-parity-phases.md†L96-L118】
- Added `wpTaxonomy` builders under `packages/cli/src/next/builders/php/printers/resource/` to normalise pagination, merge request parameters, resolve term identities, and shape term responses via AST nodes, removing the legacy string templates for taxonomy controllers.【F:packages/cli/src/next/builders/php/printers/resource/wpTaxonomy/list.ts†L1-L257】【F:packages/cli/src/next/builders/php/printers/resource/wpTaxonomy/get.ts†L1-L133】【F:packages/cli/src/next/builders/php/printers/resource/wpTaxonomy/helpers.ts†L1-L260】
- Registered the taxonomy helpers in the resource controller so taxonomy routes emit cache metadata, include the necessary `WP_Term`/`WP_Term_Query` imports, and append the private helper methods alongside the queued list/get route bodies.【F:packages/cli/src/next/builders/php/printers/resourceController/routes/list.ts†L1-L201】【F:packages/cli/src/next/builders/php/printers/resourceController/routes/get.ts†L1-L122】【F:packages/cli/src/next/builders/php/printers/resourceController.ts†L71-L206】
