...
| Phase 6 - core pipeline alignment (completed) | Align CLI docs with `packages/core/docs/phase-6-core-pipeline.md.md` (Tasks 32-36).                                                                          | **0.10.0**    | 0.9.1 → 0.10.0 (shipped)  | Baseline + documentation linting                                              |
