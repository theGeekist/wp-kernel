...
- Telemetry instrumentation and integration smoke coverage for the published bootstrap binary to confirm flags like `--force` reach `wpk create` (Task 38 installment 2).
