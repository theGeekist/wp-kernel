...
- **[CLI IR Lifecycle Map](ir-lifecycle.json)** - machine-readable reference covering fragment/builders ordering, data flow, and extension hook timing for the CLI pipeline.
