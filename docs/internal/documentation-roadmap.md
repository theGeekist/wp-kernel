...
| Action Bindings       | `ActionButton`, `useAction`                                                                       | Trigger kernel actions from UI without touching transports directly. All exports in `packages/ui/src/hooks/useAction.ts` have JSDoc.                                                                                                                                                                              |
...
| Docs Task 17 – JSDoc audit for exported test-utils APIs (✓ Complete)
...
| UI Harness        | `createKernelUITestHarness`                                                | Kernel UI provider + runtime harness with console guards and registry reset helpers. All exports in `packages/test-utils/src/ui/kernel-ui-harness.ts` have JSDoc.                                                                                                      |
...
| Docs Task 21 – JSDoc audit for exported e2e-utils APIs (🚧 In Progress)
...
| Category         | Symbols                                                           | Notes                                                                                                                             |
| ---------------- | ----------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| Test Fixtures    | `test`, `expect`, `createKernelUtils`                             | Extended Playwright test with `kernel` fixture pre-configured. All exports in `packages/e2e-utils/src/index.ts` have JSDoc.       |
...
| Docs Task 29 – JSDoc audit for exported create-wpk APIs (✓ Complete)
