...
| Extension System       | `PipelineExtension`, `PipelineExtensionHook`, `PipelineExtensionHookOptions`, `PipelineExtensionHookResult`, `PipelineExtensionRollbackErrorMetadata` | Extension hook system for pre-run/post-build lifecycle integration. Enables atomic operations with commit/rollback support. |
