...
[@wpkernel/ui](../README.md) / DataViewsEventPayloadMap

# Type Alias: DataViewsEventPayloadMap

```ts
type DataViewsEventPayloadMap = object;
```
...
```ts
ui: dataviews: registered: DataViewRegisteredPayload;
```
...
```ts
ui: dataviews: unregistered: DataViewRegisteredPayload;
```
